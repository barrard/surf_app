...
function init() {
  const hawaii = { lat1: "23.558N", lng1: "153.900W" };
  // get_nearby_stations(hawaii)//{lat1:'23.558N' ,  lng1:'153.900W' }
}

/* Get master list */
async function get_nearby_stations({ lat1, lon1 }) {
  logger.log("getting station list");
  // var station_list_html = await rp(`https://www.ndbc.noaa.gov/radial_search.php?lat1=${lat1}N&lon1=${lon1}&uom=E&dist=250')
